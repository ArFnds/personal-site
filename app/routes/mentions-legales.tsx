		...
		<section className="container mx-auto px-4 py-4 ">
			<div className="prose max-w-full">
				...
				<p>
					...
					<a href="https://arnaudfernandes.com/">
						https://arnaudfernandes.com/
					</a>{" "}
				...
				<p>
					<strong>Propriétaire</strong> : SAS Tech Magister Capital social de
					1000€ Numéro de TVA: FR80891906422 – 9 rue des colonnes 75002 Paris
					<br />
					<strong>Responsable publication</strong> : Arnaud Fernandes –
					me@arnaudfernandes.com
					<br />
					Le responsable publication est une personne physique ou une personne
					morale.
					<br />
					<strong>Webmaster</strong> : Arnaud Fernandes – me@arnaudfernandes.com
					<br />
					<strong>Hébergeur</strong> : 1and1 – 7 Place de la Gare 57200
					Sarreguemines 0970 808 911
					<br />
					<strong>Délégué à la protection des données</strong> : Arnaud
					Fernandes – me@arnaudfernandes.com
					<br />
				</p>
				<h2>
				...
				<p>
					...
					le responsable du traitement des Données Personnelles est : Tech
					Magister.{" "}
					<a href="https://arnaudfernandes.com/">
						https://arnaudfernandes.com/
					</a>
					est représenté par Arnaud Fernandes, son représentant légal
				</p>
				<p>
				...
				Tech Magister – DPO, Arnaud Fernandes <br />9 rue des colonnes 75002
				Paris.
				<p>
